...
\begin{figure}[h!]
  \begin{algorithmic}[1]
    \Function{obscureFaces}{\tt p} \Comment p = absolute path
		...
		\State {\tt cv\_2} $\gets$ OpenCV 2 libarary
		...
		\State {\tt ObscureRdd} $\gets$ {\bf paintBlack}({\tt FaceRdd}) \Comment Fills the rectagles with black
...
\begin{figure}
	...
	\includegraphics[width=0.5\linewidth]{figures/OrigOnePerson.png}
	}
	\subfloat[Obscured image, image1 ]{
	\includegraphics[width=0.5\linewidth]{figures/ObsOnePerson.png}
	}\\
	\subfloat[Original image, image2]{
	\includegraphics[width=0.5\linewidth]{figures/OrigTwoPeople.png}
	}
	\subfloat[Obscured image, image2]{
	\includegraphics[width=0.5\linewidth]{figures/ObsTwoPeople.png}
	}\\
	\subfloat[Original image, image3]{
	\includegraphics[width=0.5\linewidth]{figures/OrigFailed.png}
	}
	\subfloat[Failed case, image3]{
	\includegraphics[width=0.5\linewidth]{figures/ObsFailed.png}
	}
